0x09-web_infra10structure_design
Concepts
...
Specifics About This Infrastructure
    ...
    To provide a human-friendly alias for an IP Address. For example, the domain name www.wikipedia.org is easier to recognize and remember than 10.61.30.103 The IP address and domain name alias is mapped in the Domain Name System (DNS)
